...
Design system completo — paleta gold/black da Founders Led Growth.
"""


SLIDES_SYSTEM_PROMPT = """\
Você é um especialista em comunicação estratégica da Founders Led Growth (FLG).
...
def build_slides_prompt(
    ...
    return f"""\
Gere uma apresentação HTML completa para o seguinte encontro da Founders Led Growth.
